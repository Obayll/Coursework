...
#define DEBUG(DB_LOCORE, "Memory initialized\n");
#define DEBUG(DB_LOCORE, "Memory full\n");
#define DEBUG(DB_LOCORE, "Memory data overwritten\n");
#define DEBUG(DB_SYSCALL, "Entering user mode\n");
#define DEBUG(DB_SYSCALL, "Leaving user mode\n");
#define DEBUG(DB_INTERRUPT, "Interrupt caught\n");
#define DEBUG(DB_INTERRUPT, "Interrupt put in queue\n");
#define DEBUG(DB_INTERRUPT, "Interrupt conflict\n");
#define DEBUG(DB_THREADS, "New thread created\n");
#define DEBUG(DB_THREADS, "Thread deleted\n");
#define DEBUG(DB_THREADS, "Sleeping thread created\n");
#define DEBUG(DB_THREADS, "Zombie thread created\n");
#define DEBUG(DB_THREADS, "Zombie threads exorcised\n");
